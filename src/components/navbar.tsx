  ...
  return (
    <div class="navbar bg-base-200 rounded-2xl">
      ...
      <div class="navbar-start hidden md:flex">
        <A class="btn btn-ghost text-xl" href="/home">My Lists</A>
      </div>
      ...
      <div class="navbar-end">
        ...
        <label class="swap swap-rotate mr-5">
          <input type="checkbox" class="theme-controller" value="synthwave" checked={darkMode()} onChange={() => setDarkMode(!darkMode())}/>
          <svg
